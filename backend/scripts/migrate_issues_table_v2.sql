-- 步骤 0: 删除依赖的视图
DROP VIEW IF EXISTS v_issues_summary;
DROP VIEW IF EXISTS v_rectification_progress;
DROP VIEW IF EXISTS v_rectification_notices_summary;
DROP VIEW IF EXISTS v_issues_by_type;
